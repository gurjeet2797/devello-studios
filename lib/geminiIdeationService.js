/**
 * Gemini Ideation Service (LEGACY)
 * 
 * @deprecated This single-step approach is deprecated.
 * Use the new multi-stage pipeline at lib/engine instead.
 * 
 * The v2 engine provides:
 * - Multi-stage pipeline with schema validation
 * - Research → Concept → Screens → Images → Mockup
 * - Caching, retries, and progress tracking
 * 
 * See: lib/engine/index.js and lib/ideationJobProcessor.js
 * 
