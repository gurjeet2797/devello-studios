/**
 * Creative Intelligence Engine Prompt Templates
 * 
 * These prompts are designed for Gemini 2.5 to transform app ideas
 * into complete product concepts with structured JSON output.
 */
